...
def coor():
	...
	while(cap.isOpened()):
		...
		if len(cnts) > 0:
			...
			convX = (29.3 * center[i][0] / 340) + errorX
			convY = (42 * center[i][1] / 480) + errorY
		        coor = (convX, convY)
			...
			theta2 =  2.4 - ( phi1 + phi2 ).evalf(subs={'pi':3.14}) #140 degree
			...
			theta3 = ( phi3).evalf(subs={'pi':3.14}) #- 0.174 #10 degree
		...
		if cv2.waitKey(1) & 0xFF == ord('k'):
				...
				time.sleep(2) #this delay is the key
				ser.close()
				#break
